...
public class Fighter extends Unit
{
	...
	{	
		super(hp, currentAction, attackRange, attackSpeed, maxSpeed, damage, range, armor, position, id, description, destination, hpMax, faction, sightRange, maxFrame, graphicsManager,EntityConfiguration.DEFENSIF_STATE);
		this.state = state;
