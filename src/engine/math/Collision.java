...
public class Collision {
	...
	public static boolean collideVision(Entity target , Unit attacker) 
	{
		...
		Rectangle r1 = new Rectangle(target.getPosition().getX(), target.getPosition().getY(), sizeTarget, sizeTarget);
		Rectangle r2 = new Rectangle(attacker.getPosition().getX() - attacker.getSightRange()/2*sizeAttacker, attacker.getPosition().getY() - attacker.getSightRange()/2*sizeAttacker, attacker.getSightRange()*2*sizeAttacker, attacker.getSightRange()*2*sizeAttacker);
